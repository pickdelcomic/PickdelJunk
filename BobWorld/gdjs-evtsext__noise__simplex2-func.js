...
gdjs.evtsExt__Noise__Simplex2.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.returnValue = gdjs.evtsExt__Noise__Noise2d.func(runtimeScene, "", eventsFunctionContext.getArgument("X"), eventsFunctionContext.getArgument("Y"), eventsFunctionContext);}
}
